...
namespace GestionFacturation.Controllers
{
    ...
    public class UtilisateursController : ControllerBase
    {
        ...
        //authentication + registration "service + mapper + appsettings variables"
        private IUserService _utilisateurService;
